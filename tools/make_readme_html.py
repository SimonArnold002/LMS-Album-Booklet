...
ZIP_NAME = "AlbumBooklet.zip"
GITHUB_URL = "https://github.com/SimonArnold002/LMS-Album-Booklet"
# The version badge is read live from install.xml; the rest are static.
STATIC_BADGES = ["LMS 9.0.0+", "Material Skin 6.4.3+", "Now Playing"]


def read_version(root):
    """Current plugin version from install.xml (the single source of truth)."""
    try:
        with open(os.path.join(root, "AlbumBooklet", "install.xml"), encoding="utf-8") as f:
...
<title>Album Booklet — LMS Plugin</title>
</head>
<body>
<p>Redirecting to <a href="README.html">the Album Booklet page</a>…</p>
</body>
</html>
"""
